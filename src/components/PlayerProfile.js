...
const PlayerProfile=()=>{
  ...
  const f=useSelector(selectFollow);
    ...
    return(
        <div className="profile" style={{backgroundColor:"whitesmoke",position:"relative"}}>
             <HeaderBack 
                title_redux={false} 
      ...
      >Unfollow</button>}
              ...
              <div className="player_profile">
               ...
               {/*} <Tabs value={tab} fullWidth style={styles.tabs} onChange={handleChange} variant="fullWidth">
                <Tab label="Ranking" />
