...
const ProfileTopStats = ({userInfo,onfollow,onunfollow,onchallenge,me}) => {
   ...
   useEffect(()=>{
    ...
    return (
        <div className="profileTopStats_parent" style={{position:"relative"}}>
           
		   {(me==false && following==false) && 
			<button className="profile_follow_btn" onClick={onfollow}>
		   <ReplyIcon />
		   Follow</button>} 
		   
		   {(me==false && following==true) && <button className="profile_unfollow_btn" onClick={onunfollow}>
		   <ReplyIcon />
		   Unfollow</button>} 
		   
		   {me==false && <button className="profile_challenge_btn" onClick={challenge_player}>
		   <GroupIcon />
		   Challenge</button>}
		   
		    {me==true && <button className="profile_challenge_btn" onClick={edit_profil}>
		   <EditIcon />
		   Edit profile</button>}
            ...
            <div className="top_img">
                ...
                <p style={{color:"gray",fontSize:"0.7rem"}}>{status}</p>
