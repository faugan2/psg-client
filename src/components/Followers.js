...
const Followers = () => {
    ...
    return (
        <div className="picks_bought" style={{backgroundColor:"whitesmoke",minHeight:"100vh"}}>
            <HeaderBack title_redux={false} title="My Club" show_menu={false} show_empty_div={true}></HeaderBack>
                ...
                }
			{
				data.map((user,i)=>{
					...
					return(
						<div className="player" key={user.key} style={{backgroundColor:"white"}}>
            <div className="player_header">
                ...
                <div>
                    <button onClick={challenge_user.bind(this,user)} style={{
						display:"flex",
