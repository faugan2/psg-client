                  ...
                  my_picks.map((pick,i)=>{
                    ...
                    // //console.log(pick);
                     ...
                     let str_bought="";
                      ...
                      return(
                        <div className="today_games_game" key={i} style={{margin:"1rem"}}>
                       ...
                       {can_buy==true && <div className="today_game_top">
                            
                            {userInfo==undefined && <button className="hide">Can't buy</button>}
                            {can_buy==true && <button 
                            className={str_bought} 
                            onClick={buy_pick.bind(this,pick,game_icon,str_league,str_bought)} style={{
                                fontSize:"0.6rem"
                            }}>
                                {checked_icon}
                                BUY {can_buy}
                            ...
                            <div>
                                <button style={{fontSize:"0.7rem"}}>{str_type_pick}</button>
                            ...
                            {userInfo!=undefined && <button style={{fontSize:"0.7rem"}}>1000 Coins</button>}
                            {userInfo==undefined && <button className="hide" style={{display:"none"}}>1000 Coins</button>}
